...
Covers 20 all-time classic books on positioning, copywriting mechanics, cognitive heuristics, and strategy.
Special focus on user-specified pillars:
...
ALL_MASTER_BOOKS = [
    ...
    # ── 7. 《The Copy Book 全球32位顶尖广告文案写作之道》（英国D&AD协会） ──
    {
...
def rebuild_books_database_and_json():
    ...
    json_file.write_text(json.dumps({
        "version": "v2.6.0",
        "description": "Masterclass Advertising & Copywriting Books Knowledge Base (20 Pillars)",
